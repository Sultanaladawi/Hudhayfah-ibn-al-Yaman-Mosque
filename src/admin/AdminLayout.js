        ...
        <header style={{
          ...
          <audio ref={undefined} style={{display:'none'}} />
            ...
            {newOrderCount > 0 && (
              ...
              >
                <BellRing size={16} color="#D4AF37" style={{ animation: 'bellRing 0.5s infinite alternate' }} />
                <span style={{ color: '#D4AF37', fontWeight: '900', fontSize: '0.8rem', letterSpacing: '0.5px' }}>
            ...
            {showAudioBtn && (
              ...
              >
                <BellRing size={16} /> إيقاف التنبيه
              </button>
            )}
            ...
            >
              ...
              <span style={{
                ...
                {manualStatus === 'auto' ? <><Store size={14} /> تلقائي</> :
                  manualStatus === 'manual_open' ? <><Coffee size={14} /> المسجد مفتوح</> :
                    <><Power size={14} /> المسجد مغلق</>}
              </span>
            </button>

...
const DEFAULT_CLASSES = [
  ...
  { id: 2, name: 'حلقة الضحى', teacher: 'الشيخ همام النجار', students: 18, time: '9:00 ص — 11:00 ص', level: 'مبتدئ', color: '#D4AF37' },
...
export default function Circles() {
  ...
  const handleAdd = () => {
    ...
    const newCircle = {
      ...
      students: 0,
      color: ['#2D1F0E', '#D4AF37', '#2980b9', '#8e44ad', '#e67e22', '#B8860B'][classes.length % 6]
    };

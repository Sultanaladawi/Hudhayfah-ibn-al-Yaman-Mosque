...
export default function Hero() {
  ...
  return (
    ...
    {/* Live Stream Section */}
    <section style={{ backgroundColor: '#F2E8D5', padding: '60px 20px', width: '100%', display: 'flex', justifyContent: 'center' }}>
      <div style={{
        background: '#FBF6EE',
        ...
        width: '100%',
        maxWidth: '900px',
        boxShadow: '0 12px 40px rgba(139, 105, 20, 0.15)',
        boxSizing: 'border-box',
        textAlign: 'center',
      }}>
        <h3 style={{ fontFamily: "'Amiri', serif", color: '#2D1F0E', fontSize: '1.6rem', margin: '0 0 20px 0', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
           🕋 البث المباشر لقناة القرآن الكريم (مكة المكرمة)
        </h3>
        <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden', borderRadius: '16px', border: '1.5px solid rgba(212,175,55,0.4)' }}>
          <iframe
            src="https://www.youtube.com/embed/QOXPhLT9zU4?autoplay=1&mute=1"
        ...
        <p style={{ color: '#6B4F35', fontSize: '0.95rem', marginTop: '15px', fontFamily: 'Tajawal', lineHeight: '1.6' }}>

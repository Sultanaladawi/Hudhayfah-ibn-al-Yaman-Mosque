        ...
        <div className={styles.modalBody} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <form className={styles.form} onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div className={styles.formSection} style={{ backgroundColor: '#fff', padding: '25px', borderRadius: '20px', border: '1px solid #eee', marginBottom: '25px', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', direction: 'rtl' }}>
              <label className={styles.label} style={{ fontSize: '1.25rem', color: '#2D1F0E', marginBottom: '20px', display: 'block', fontWeight: '800', fontFamily: "'Amiri', 'Tajawal', sans-serif", textAlign: 'center' }}>تحديد باب المساهمة والخير:</label>
              <div className={styles.orderTypeGrid} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '15px' }}>
                <div
                  ...
                  style={{
                    ...
                    border: orderType === 'general' ? '2px solid #2D1F0E' : '2px solid transparent',
                    backgroundColor: orderType === 'general' ? 'rgba(139,105,20,0.08)' : '#f8f9fa',
                    boxShadow: orderType === 'general' ? '0 10px 25px rgba(139,105,20,0.14)' : 'none',
                    transform: orderType === 'general' ? 'translateY(-4px)' : 'translateY(0)'
                  }}
                >
                  <i className="fas fa-hand-holding-heart" style={{ fontSize: '2rem', color: orderType === 'general' ? '#2D1F0E' : '#a0a0a0', marginBottom: '12px', transition: '0.3s' }} />
                  <div style={{ fontWeight: '800', color: orderType === 'general' ? '#2D1F0E' : '#777', fontSize: '1rem', fontFamily: 'Tajawal' }}>صدقة عامة</div>
                ...
                <div
                  ...
                  style={{
                    padding: '20px 10px', textAlign: 'center', borderRadius: '16px', cursor: 'pointer', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                    border: orderType === 'quran' ? '2px solid #2D1F0E' : '2px solid transparent',
                    backgroundColor: orderType === 'quran' ? 'rgba(139,105,20,0.08)' : '#f8f9fa',
                    boxShadow: orderType === 'quran' ? '0 10px 25px rgba(139,105,20,0.14)' : 'none',
                    transform: orderType === 'quran' ? 'translateY(-4px)' : 'translateY(0)'
                  }}
                >
                  <i className="fas fa-book-open" style={{ fontSize: '2rem', color: orderType === 'quran' ? '#2D1F0E' : '#a0a0a0', marginBottom: '12px', transition: '0.3s' }} />
                  <div style={{ fontWeight: '800', color: orderType === 'quran' ? '#2D1F0E' : '#777', fontSize: '1rem', fontFamily: 'Tajawal' }}>كفالة الحلقات</div>
                ...
                <div
                  ...
                  style={{
                    padding: '20px 10px', textAlign: 'center', borderRadius: '16px', cursor: 'pointer', transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                    border: orderType === 'maintenance' ? '2px solid #2D1F0E' : '2px solid transparent',
                    backgroundColor: orderType === 'maintenance' ? 'rgba(139,105,20,0.08)' : '#f8f9fa',
                    boxShadow: orderType === 'maintenance' ? '0 10px 25px rgba(139,105,20,0.14)' : 'none',
                    transform: orderType === 'maintenance' ? 'translateY(-4px)' : 'translateY(0)'
                  }}
                >
                  <i className="fas fa-tools" style={{ fontSize: '2rem', color: orderType === 'maintenance' ? '#2D1F0E' : '#a0a0a0', marginBottom: '12px', transition: '0.3s' }} />
                  <div style={{ fontWeight: '800', color: orderType === 'maintenance' ? '#2D1F0E' : '#777', fontSize: '1rem', fontFamily: 'Tajawal' }}>صيانة وإعمار</div>

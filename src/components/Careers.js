                ...
                <form onSubmit={handleSubmit} className={styles.form} noValidate>
                  ...
                  {statusMsg.text && (
                    <div style={{
                      ...
                      borderRadius: '10px',
                      marginBottom: '14px',
                      background: statusMsg.type === 'success' ? 'rgba(201,168,76,0.12)' : 'rgba(231,76,60,0.12)',
                      border: `1px solid ${statusMsg.type === 'success' ? '#B8860B' : '#e74c3c'}`,
                      color: statusMsg.type === 'success' ? '#B8860B' : '#e74c3c',
                      fontSize: '0.92rem',
                      fontFamily: "'Tajawal', sans-serif",
                      textAlign: 'right',
                      lineHeight: '1.6'
